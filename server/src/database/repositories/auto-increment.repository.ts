...
type AutoIncrementDelegate = Prisma.AutoIncrementDelegate<any>

@Injectable()
export class AutoIncrementRepository extends Repository<
  AutoIncrementDelegate,
  DelegateArgs<AutoIncrementDelegate>,
  DelegateReturnTypes<AutoIncrementDelegate>
> {
  constructor(private prisma: PrismaService) {
    super(prisma.autoIncrement)
  }
}
