  ...
  return (
    <ul id="countdown-wrapper" className="flex sm:gap-5 gap-2 lg:gap-10">
      <li className="sm:w-28 sm:h-28 w-24 h-24 flex flex-col justify-center items-center border-2 border-success-100 dark:border-white  rounded-lg">
        <h2 id="days" className="sm:text-[48px] text-xl dark:text-white font-semibold text-black font-poppins">
          {remainingTime.days}
        </h2>
        <span className="font-medium text-bgray-600 dark:text-white">Days</span>
      </li>
      <li className="sm:w-28 sm:h-28 w-24 h-24 flex flex-col justify-center items-center border-2 border-success-100 dark:border-white rounded-lg">
        <h2 id="hours" className="sm:text-[48px] text-xl font-semibold text-black dark:text-white font-poppins">
          {remainingTime.hours}
        </h2>
        <span className="font-medium text-bgray-600 dark:text-white">Hours</span>
      </li>
      <li className="sm:w-28 sm:h-28 w-24 h-24 flex flex-col justify-center items-center border-2 border-success-100 dark:border-white rounded-lg">
        <h2 id="minutes" className="sm:text-[48px] text-xl font-semibold dark:text-white text-black font-poppins">
          {remainingTime.minutes}
        </h2>
        <span className="font-medium text-bgray-600 dark:text-white">Minutes</span>
      </li>
      <li className="sm:w-28 sm:h-28 w-24 h-24 flex flex-col justify-center items-center border-2 border-success-100 rounded-lg dark:border-white">
        <h2 id="seconds" className="sm:text-[48px] text-xl dark:text-white font-semibold text-black font-poppins">
          {remainingTime.seconds}
        </h2>
        <span className="font-medium text-bgray-600 dark:text-white">Seconds</span>
      </li>
    </ul>
  )
}
