import user from '@/app/_common/assets/images/avatar/user-1.png'
import groupImg1 from '@/app/_common/assets/images/avatar/group-img-1.png'
import groupImg2 from '@/app/_common/assets/images/avatar/group-img-2.png'
import groupImg3 from '@/app/_common/assets/images/avatar/group-img.png'
import hr from '@/app/_common/assets/images/avatar/hr.png'
  ...
  return (
    <aside className="2xl:w-[382px] w-full bg-white dark:bg-darkblack-600 rounded-lg px-12 pb-7">
      <header className="flex flex-col items-center text-center -mt-8 pb-7">
        <Image priority={true} height={user.height} width={user.width} src={user.src} className="rounded-lg" alt="" />
        <h3 className="text-xl font-bold text-bgray-700 dark:text-white mt-4">Abdur Rohman</h3>
          ...
          >
            ...
            >
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M6.69995 9.26572L13.3 5.86572" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M6.69995 11.8657L13.3 15.2657" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
        </div>
      </header>
      <ul className="py-7 border-t border-b border-gray-200 dark:border-darkblack-400 space-y-6">
        <li className="flex justify-between">
          <span className="font-medium text-gray-500 text-sm dark:text-white">Experience</span>
          <span className="text-sm font-semibold text-bgray-900 dark:text-white">2-4 Years</span>
        </li>
        <li className="flex justify-between">
          <span className="font-medium text-gray-500 text-sm dark:text-white">Seniority Level</span>
          <span className="text-sm font-semibold text-bgray-900 dark:text-white">Senior Level</span>
        </li>
        <li className="flex justify-between">
          <span className="font-medium text-gray-500 text-sm dark:text-white">Employment</span>
          <span className="text-sm font-semibold text-bgray-900 dark:text-white">Full Time</span>
        </li>
        <li className="flex justify-between">
          <span className="font-medium text-gray-500 text-sm dark:text-white">Salary</span>
          <span className="text-sm font-semibold text-bgray-900 dark:text-white">$250-300</span>
        </li>
      </ul>
          ...
          <li className="bg-[#E4FDED] dark:bg-darkblack-500 py-3 px-2 pr-4 flex justify-between items-center rounded-lg">
            <div className="flex items-center gap-x-3">
              ...
              <div className="flex flex-col">
                <h5 className="font-semibold text-bgray-900 dark:text-white text-sm">Overview.pdf</h5>
            ...
            <button aria-label="none">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M10 12.4995V2.49951" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
          </li>
          <li className="bg-[#E4FDED] dark:bg-darkblack-500 py-3 px-2 pr-4 flex justify-between items-center rounded-lg">
      ...
      <div className="pt-6">
        <h4 className="font-medium text-gray-500 text-sm dark:text-white mb-4">Hiring Agent</h4>
        <div className="flex gap-x-4">
          <div>
            <Image priority={true} height={hr.height} width={hr.width} src={hr.src} alt="" />
          </div>
          <div>
            <h5 className="text-base font-semibold text-bgray-900 dark:text-white">Annette Black</h5>
