...
import mastar from '@/app/_common/assets/images/payments/master-mini.svg'
    ...
    <div className="payment-select relative mb-3">
      ...
      >
        <div className="flex items-center space-x-2">
          <span>
            <Image priority={true} height={mastar.height} width={mastar.width} src={mastar.src} alt="master" />
          </span>
