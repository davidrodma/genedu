...
import userImg from '@/app/_common/assets/images/message/u-lg.png'
    ...
    >
      <header className="pb-8 border-b border-bgray-300 dark:border-darkblack-400">
        <div className="flex justify-between">
          <h3 className="text-bgray-900 dark:text-white font-bold text-2xl">User Info</h3>
          <button aria-label="none" type="button" onClick={close} className="text-bgray-400 hover:text-red-500">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <div className="flex flex-col items-center mt-6">
          <Image
            ...
            alt=""
          />
          <h4 className="font-bold text-xl text-bgray-900 dark:text-white mb-2">Ajoy Sarker</h4>
          <span className="font-medium text-sm text-bgray-500 dark:text-bgray-50">UX Researcher</span>
          <div className="bg-bgray-50 dark:bg-darkblack-500 rounded-xl flex space-x-2 items-center p-3 mt-4">
            ...
            <span className="font-medium text-sm text-bgray-900 dark:text-white">Quomodosoft Team</span>
          </div>
        </div>
      </header>
      <div className="py-6">
              ...
              <div className="bg-bgray-50 dark:bg-darkblack-500 w-10 h-10 rounded-lg flex justify-center items-center">
                <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <path d="M5 7H6" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M5 11H11" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M5 15H11" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div>
                <h5 className="text-base font-semibold dark:text-white">Reference.zip</h5>
                <span className="text-sm text-bgray-500 dark:text-bgray-50">2 MB</span>
              </div>
            </div>
            <div>
              ...
              <div className="bg-bgray-50 dark:bg-darkblack-500 w-10 h-10 rounded-lg flex justify-center items-center">
                <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <path d="M5 7H6" stroke="#436CFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M5 11H11" stroke="#436CFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M5 15H11" stroke="#436CFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div>
                <h5 className="text-base font-semibold dark:text-white">Doc0001.docx</h5>
                <span className="text-sm text-bgray-500 dark:text-bgray-50">1,025 KB</span>
              </div>
            </div>
            <div>
              <button aria-label="none" type="button" className="text-bgray-500 hover:text-red-500">
              ...
              <div className="bg-bgray-50 dark:bg-darkblack-500 w-10 h-10 rounded-lg flex justify-center items-center">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <path d="M9 9H10" stroke="#FF4747" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M9 13H15" stroke="#FF4747" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M9 17H15" stroke="#FF4747" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div>
                <h5 className="text-base font-semibold dark:text-white">Filex.pdf</h5>
                <span className="text-sm text-bgray-500 dark:text-bgray-50">2,25 KB</span>
              </div>
            </div>
            <div>
              <button aria-label="none" type="button" className="text-bgray-500 hover:text-red-500">
          ...
          <li className="flex justify-between items-center">
            <div className="flex space-x-3">
              ...
              <div>
                ...
                <span className="text-sm text-bgray-500 dark:text-bgray-50">https://muz.li.com</span>
              </div>
            </div>
            <div>
              <button aria-label="none" type="button" className="text-bgray-500 hover:text-red-500">
          ...
          <li className="flex justify-between items-center">
            <div className="flex space-x-3">
              ...
              <div>
                ...
                <span className="text-sm text-bgray-500">https://dribbble.com/rf...</span>
              </div>
            </div>
            <div>
              <button aria-label="none" type="button" className="text-bgray-500 hover:text-red-500">
      ...
      <div className="bg-bgray-100 dark:bg-darkblack-500 p-6 mt-4 rounded-lg">
        <div className="flex space-x-6 items-center">
              ...
              <div className="bonus-outer">
                <div className="bonus-inner">
                  <div className="number">
                    <span className="text-sm font-medium text-bgray-900">26%</span>
                  </div>
                </div>
              </div>
          ...
          <div>
            <h4 className="text-bgray-900 text-base dark:text-white font-bold">Complete profile</h4>
