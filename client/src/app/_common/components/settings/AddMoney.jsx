import paypalsm from '@/app/_common/assets/images/payments/paypal-smsvg.svg'
import visa from '@/app/_common/assets/images/payments/visa.svg'
import master from '@/app/_common/assets/images/payments/master.svg'
import member from '@/app/_common/assets/images/avatar/members-3.png'
    ...
    <>
      ...
      <div className="2xl:w-[400px] lg:w-[250px] w-full">
        <div className="w-full">
          <h3 className="text-lg font-bold text-bgray-900 dark:text-white mb-4">Add money</h3>
          <CardSelect
            currencyOptions={[
              <Image
                priority={true}
                ...
                key="1"
              />,
              <Image priority={true} height={visa.height} width={visa.width} src={visa.src} alt="master2" key="2" />,
              <Image
                priority={true}
          ...
          <div className="w-full rounded-lg border border-bgray-200 dark:border-darkblack-400 focus-within:border-success-300 p-4 h-[98px] flex flex-col justify-between">
            <p className="text-sm text-bgray-600 dark:text-darkblack-300 font-medium">Enter amount</p>
            <div className="w-full h-[35px] flex justify-between items-center">
              ...
              <div>
                <Image priority={true} height={member.height} width={member.width} src={member.src} alt="members" />
              </div>
            </div>
          </div>
          <button
