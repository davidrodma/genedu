...
import profileImg from '@/app/_common/assets/images/avatar/profile.png'
import coverImg from '@/app/_common/assets/images/others/cover.jpg'
...
function PersonalInfo({ name, activeTab }: { name: string; activeTab: string }) {
      ...
      <div className="xl:grid grid-cols-12 gap-12 flex 2xl:flex-row flex-col-reverse">
        ...
        <div className="2xl:col-span-4 xl:col-span-5 2xl:mt-24">
          <header className="mb-8">
            <h4 className="font-bold text-lg text-bgray-800 dark:text-white mb-2">Update Profile</h4>
            <p className="mb-4 text-bgray-500">
              Profile of at least Size
              <span className="text-bgray-900 dark:text-darkblack-300">300x300.</span> Gifs work too.
              <span className="text-bgray-900">Max 5mb.</span>
            </p>
            <div className="text-center m-auto w-40 h-40 relative">
              <Image priority={true} height={profileImg.height} width={profileImg.width} src={profileImg.src} alt="" />
          ...
          <div>
            <h4 className="font-bold text-lg text-bgray-800 dark:text-white mb-2">Update Cover</h4>
