...
import inbox1 from '@/app/_common/assets/images/avatar/inbox-1.png'
import inbox2 from '@/app/_common/assets/images/avatar/inbox-2.png'
import inbox3 from '@/app/_common/assets/images/avatar/inbox-3.png'
import Link from 'next/link'
import Image from 'next/image'

function MessagePopup({ active, handlePopup }: { active: boolean; handlePopup: (params?: any) => void }) {
  return (
    <div className="message-popup-wrapper">
      <div
        onClick={() => handlePopup('message')}
        id="mes-outside"
      ...
      >
        <div className="relative w-full pb-[75px] pt-[66px]">
          <div className="absolute left-0 top-0 flex h-[66px] w-full items-center justify-between px-8">
            <h3 className="text-xl font-bold text-bgray-900 dark:text-white">Message</h3>
            <span>
                ...
                <Link href="#">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="mb-1 text-base font-bold text-bgray-900 dark:text-whit">James Eusobio</p>
                      <p className="text-sm font-medium text-bgray-500 dark:text-bgray-50">
                        Hi, how are you? nedd help! .......
                      </p>
                      <span className="text-sm font-medium text-bgray-500 dark:text-bgray-50">23 mins ago</span>
                    </div>
                  </div>
                </Link>
              </li>
              <li className="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
                <Link href="#">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="mb-1 text-base font-bold text-bgray-900 dark:text-white">Eusobio Joy</p>
                      <p className="text-sm font-medium text-bgray-500">Hi, how are you? nedd help! .......</p>
                      <span className="text-sm font-medium text-bgray-500">23 mins ago</span>
                    </div>
                  </div>
                </Link>
              </li>
              <li className="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
                <Link href="#">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="mb-1 text-base font-bold text-bgray-900 dark:text-white">James Camaron</p>
                      <p className="text-sm font-medium text-bgray-500">Hi, how are you? nedd help! .......</p>
                      <span className="text-sm font-medium text-bgray-500">23 mins ago</span>
                    </div>
                  </div>
              ...
              <li className="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
                <Link href="#">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="mb-1 text-base font-bold text-bgray-900 dark:text-white">James Eusobio</p>
                      <p className="text-sm font-medium text-bgray-500">Hi, how are you? nedd help! .......</p>
                      <span className="text-sm font-medium text-bgray-500">23 mins ago</span>
                    </div>
                  </div>
            ...
            <div>
              <Link href="#">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold text-success-300">Mark all as read</span>
                </div>
              </Link>
            </div>
          </div>
