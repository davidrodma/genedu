...
import member from '@/app/_common/assets/images/avatar/members.png'
import Image from 'next/image'

function StorePopUp({ active, handlePopup }: { active: boolean; handlePopup: (params?: any) => void }) {
  return (
    <div className="store-wrapper">
      ...
      >
        <div className="relative w-full p-6">
          <div className="bonus-box-wrapper w-full overflow-hidden pb-[33px]">
            <div className="bonus-box relative flex w-full justify-center">
              ...
              <div className="relative w-full rounded-lg bg-success-300 p-5">
                <h3 className="text-center text-[28px] font-bold text-white">60% Bonus</h3>
                ...
                <div className="flex justify-center">
                  <a href="#">
                    <div className="flex h-[56px] w-[166px] items-center justify-center rounded-lg bg-warning-300 transition duration-300 ease-in-out hover:bg-warning-200">
                      <span className="text-sm font-bold text-bgray-900">Discover More</span>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="bonus-outer">
                <div className="bonus-inner">
                  <div className="number">
                    <span className="text-sm font-medium text-bgray-900">25%</span>
                  </div>
                </div>
              </div>
          ...
          <p className="mb-2.5 text-center text-sm font-semibold text-success-300">Discover more</p>
          <div className="flex justify-center">
