...
function NotificationPopup({ active, handlePopup }: { active: boolean; handlePopup: (params?: any) => void }) {
  return (
      ...
      >
        <div className="relative w-full pb-[75px] pt-[66px]">
          <div className="absolute left-0 top-0 flex h-[66px] w-full items-center justify-between px-8">
            <h3 className="text-xl font-bold text-bgray-900 dark:text-white">Notifications</h3>
            <span>
            ...
            <li className="border-b border-bgray-200 py-4 pl-6 pr-[50px] hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
              <Link href="#">
                <div className="noti-item">
                  ...
                  <span className="text-xs font-medium text-bgray-500">23 mins ago</span>
                </div>
              </Link>
            </li>
            <li className="border-b border-bgray-200 py-4 pl-6 pr-[50px] hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
